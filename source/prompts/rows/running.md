...
Animation action: thoughtful in-place thinking loop based on the newest user-provided thinking reference image: head tilted, thoughtful face, one paw near the chin or cheek, the other paw tucked across the body, small hand and foot shifts, and subtle breathing. This replaces the generic in-place running action.
...
- Keep all 6 frames at a stable scale and baseline; the thinking action should read through expression and limb movement, not through body shrinking.
